...
app.config(['$provide', '$routeProvider', '$httpProvider', 'RestangularProvider', function ($provide, $routeProvider, $httpProvider, RestangularProvider) {
